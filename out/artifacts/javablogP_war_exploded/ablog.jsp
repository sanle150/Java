					...
					<main class="col-md-8">
						<article class="post post-1">
							<header class="entry-header">
								<h1 class="entry-title">${blog.b_name}</h1>
								<div class="entry-meta">
									<span class="post-date"><a href="#">${blog.b_time}</a></span>

									<span class="post-author"><a href="#">sanle</a></span>
									<form action="DeleteServlet" method="get" class="contact-form">
							...
							<div class="container">
								<div class="row">
									<main class="col-md-12">
										<article class="post">
											<div class="entry-content clearfix">
												<form action="WriteCommentsServlet" method="get" class="contact-form">
													<div class="row">
														<div class="col-md-6">
															<input type="hidden" name="b_id" value="${blog.b_id}">
															<textarea name="message" rows="7" placeholder="你的评论" required></textarea>
															<button class="btn-send btn-5 btn-5b ion-ios-paperplane"><span>发送评论</span></button>
														</div>
													</div>	<!-- row -->
												</form>
											</div>
